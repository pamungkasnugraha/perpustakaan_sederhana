...
public class ServicePerpustakaanTest {
    ...
    void testPinjamBukuGagalKetikaBukuTidakTersedia() {
        // Arrange
    ...
    // File: ServicePerpustakaanTest.java

    @Test
    @DisplayName("Hitung rating rata-rata buku")
    void testHitungRatingRataRata() {
        // Arrange: Atur perilaku mock di sini!
        // Beritahu mock untuk mengembalikan objek 'bukuTest' jika 'cariByIsbn' dipanggil dengan ISBN "1234567890".
        when(mockRepositoryBuku.cariByIsbn("1234567890")).thenReturn(Optional.of(bukuTest));
